...
const { FST_ERR_LOG_LEVEL_INVALID } = require('./errors')
...
module.exports = function override (old, fn, opts) {
  ...
  if (opts.logLevel && opts.logLevel !== 'silent' && typeof instance.log[opts.logLevel] !== 'function') {
    throw new FST_ERR_LOG_LEVEL_INVALID(opts.logLevel)
  }
